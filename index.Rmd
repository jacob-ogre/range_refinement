...
observeEvent(input$help, {
  showModal(modalDialog(
    ...
    h3("Data Sources"),
    p("There are currently two data sources for points shown in this 
      application:"),
    tags$ul(
      tags$li("'Placenames,' that is, the names of locations mentioned in texts 
    ...
    map1 <- map1 %>%
      addMarkers(
        ...
        popup = ~paste0(
          ...
          "<b>Date:</b> ", as.Date(cur_gbif()$date, origin = "1900-01-01"),
          "<br>",
