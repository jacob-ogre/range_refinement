...
observeEvent(input$help, {
  showModal(modalDialog(
    ...
    p("This app is useful for refining where species actually live based on
      ...
      misleading. For example, there may be a mention of a Fish and Wildlife 
    ...
    p(
      "As noted in Limitations, neither the placenames nor the GBIF points
...
wellPanel(
  tags$b("About"),
  p(style="font-size:small;font-family:sans-serif", 
    "A small app that combines GBIF records with placenames extracted from 
    texts of ESA regulatory documents to approximate a species' range.")
)
